...
//        // SQL Query > Select Data
//         var query = client.query("SELECT * FROM cogs121_16_raw.hhsa_san_diego_demographics_rental_statistics_2012 where \"Area\"="+"'"+area+"'");
...
//         query.on('end', function() {
//             done();
//            //not use the function but to send the data via http
